...
from ai_toolkit.tools.test_recommendation.prompts import build_test_recommendation_prompt
...
def test_prompt_includes_file_path_and_diff_content():
    prompt = build_test_recommendation_prompt([SAMPLE_HUNK])
...
def test_prompt_handles_multiple_hunks():
    ...
    prompt = build_test_recommendation_prompt([SAMPLE_HUNK, hunk2])
